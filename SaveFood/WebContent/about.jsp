		...
		<div class="row">
			<div class="col-lg-4">
				<div class="about-item-img">
					<img src="images/about/img-3.jpg" alt="" class="img-fluid w-100">
				</div>
			</div>
			...
			<div class="col-lg-8">
				<div class="about-item-content pl-4">
					...
					<p class="lead">Charite is the world’s #1 fundraising site forcharitable causes. Raise money for over 1.5 million charities.</p>
					...
					<a href="#" class="btn btn-main rounded">Learn More</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-8">
				<div class="content text-center">
					<h2 class="content-title mb-4">Worldwide partner</h2>
		...
		<div class="clients-item-wrap mt-5">
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<a href="#">
						<img src="images/clients/client1.png" alt="" class="img-fluid ">
					</a>
				</div>

				<div class="col-lg-3 col-md-6">
					<a href="#" class="mt-4 mt-lg-0">
						<img src="images/clients/client2.png" alt="" class="img-fluid">
					</a>
				</div>

				<div class="col-lg-3 col-md-6">
					<a href="#" class="mt-4 mt-lg-0">
						<img src="images/clients/client5.png" alt="" class="img-fluid">
					</a>
				</div>

				<div class="col-lg-3 col-md-6 ">
					<a href="#" class="mt-4 mt-lg-0">
						<img src="images/clients/client4.png" alt="" class="img-fluid">
					</a>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-7 text-center">
				<div class="section-title">
					...
					<h2 class="mt-3 content-title">Expert volunteer to get best service</h2>
				</div>
			</div>
		</div>
		...
		<div class="row justify-content-center">
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-item-wrap mb-5">
					<div class="team-item position-relative">
						<img src="images/team/volunteer-img1.1.jpg" alt="" class="img-fluid w-100">
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-item-wrap mb-5">
					<div class="team-item position-relative">
						<img src="images/team/volunteer-img1.2.jpg" alt="" class="img-fluid w-100">
						<div class="team-img-hover">
							<ul class="team-social list-inline">
								<li class="list-inline-item">
									<a href="#" class="facebook"><i class="icofont-facebook" aria-hidden="true"></i></a>
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
				<div class="team-item-wrap mb-5 ">
					<div class="team-item position-relative">
						<img src="images/team/volunteer-img1.3.jpg" alt="" class="img-fluid w-100">
						<div class="team-img-hover">
							<ul class="team-social list-inline">
								<li class="list-inline-item">
									<a href="#" class="facebook"><i class="icofont-facebook" aria-hidden="true"></i></a>
		...
		<div class="row justify-content-center ">
			<div class="col-lg-7 col-md-12">
				<div class="cta-content text-center">
					...
					<a href="donation.html" class="btn btn-main rounded">Make a donation</a>
				</div>
			</div>
		</div>
	</div>
				...
				<div class="col-lg-6">
					<div class="gallery-item">
						<a href="images/gallery/9.jpg" class="gallery-popup">
							<img src="images/gallery/9.jpg" alt="" class="img-fluid w-100">
						</a>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="gallery-item">
						<a href="images/gallery/8.jpg" class="gallery-popup">
							<img src="images/gallery/8.jpg" alt="" class="img-fluid w-100">
						</a>
					</div>
				</div>
			</div>
